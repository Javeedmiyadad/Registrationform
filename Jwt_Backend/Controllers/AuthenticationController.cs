...
namespace Api_project.Controllers
{
    ...
    public class AuthenticationController : Controller
    {
        ...
        public ActionResult<Designation> GetById(int id)
        {
            ...
            Designation designation = _applicationContext.designation.FirstOrDefault(s => s.desId == id);
            if (designation == null)
            {
        ...
        public ActionResult<Designation> GetByDeptId(int id)
        {
            ...
            List<Designation> designations = _applicationContext.designation.Where(x => x.departmentsid == id).ToList<Designation>();
